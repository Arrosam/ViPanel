    ...
    aiTools: {
        console: {
            ...
            loginMode: {
                ...
                devicecode: 'Log masuk dengan kod peranti',
                devicecodeNote: 'Buka pautan di bawah pada mana-mana peranti dan masukkan kod sekali guna',
            },
            loginFollowOutput: 'Ikut arahan dalam output terminal di bawah',
            install: 'Pasang',
            installTitle: 'Pasang ejen',
            installStart: 'Mula pemasangan',
            installRunning: 'Sedang memasang… mungkin mengambil masa beberapa minit',
            installOk: 'Berjaya dipasang',
            installFail: 'Pemasangan gagal — lihat output di atas',
            done: 'Selesai',
            installWarn: 'Ini memasang perisian pada pelayan ini sebagai root. Teruskan hanya jika anda mempercayai sumber di atas.',
            agentManage: 'Ejen',
            agentManageHint: 'Urus ejen pengekodan yang tersedia pada pelayan ini, serta akaun yang anda log masuk.',
            addAccount: 'Tambah akaun lain',
            saveAccount: 'Ingat akaun ini',
            accountSaved: 'Akaun disimpan',
            accountSwitched: 'Akaun ditukar',
            accountSwitchedRestart: 'Ditukar — mulakan semula sesi yang sedang berjalan untuk berkuat kuasa',
            ...
            brandTagline: 'Panel pengurusan pelayan sumber terbuka untuk individu. Uruskan aplikasi, laman web, kontena dan pangkalan data — dengan pembantu AI terbina yang boleh melaksanakan operasi untuk anda.',
            brandPoint1: 'Pembantu AI berjalan pada hos, bukan dalam kontena, jadi ia boleh menguruskan keseluruhan mesin',
            brandPoint2: 'Setiap perubahan disahkan dalam pelayar anda dalam bahasa mudah — tiada JSON mentah',
            brandPoint3: 'Nod tunggal, sumber terbuka, dihoskan sendiri',
            brandFork: 'Versi diubah suai 1Panel · GPL-3.0 · Tidak bersekutu dengan FIT2CLOUD',
