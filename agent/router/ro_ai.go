...
func (a *AIToolsRouter) InitRouter(Router *gin.RouterGroup) {
	...
	baseApi := v1.ApiGroupApp.BaseApi
	{
		...
		aiToolsRouter.POST("/console/sessions/delete", baseApi.DeleteViSession)
		aiToolsRouter.POST("/console/sessions/activate", baseApi.ActivateViSession)
		...
		aiToolsRouter.POST("/console/accounts/activate", baseApi.ActivateViAccount)
		aiToolsRouter.POST("/console/accounts/delete", baseApi.DeleteViAccount)
