    ...
    aiTools: {
        console: {
            ...
            loginMode: {
                ...
                devicecode: 'Entrar com código de dispositivo',
                devicecodeNote: 'Abra o link abaixo em qualquer dispositivo e digite o código de uso único',
            },
            loginFollowOutput: 'Siga as instruções na saída do terminal abaixo',
            install: 'Instalar',
            installTitle: 'Instalar agente',
            installStart: 'Iniciar instalação',
            installRunning: 'Instalando… pode levar alguns minutos',
            installOk: 'Instalado',
            installFail: 'Falha na instalação — veja a saída acima',
            done: 'Concluído',
            installWarn: 'Isso instala software neste servidor como root. Prossiga apenas se confiar na origem indicada acima.',
            agentManage: 'Agentes',
            agentManageHint: 'Gerencie os agentes de codificação disponíveis neste servidor e as contas usadas para entrar.',
            addAccount: 'Adicionar outra conta',
            saveAccount: 'Lembrar esta conta',
            accountSaved: 'Conta salva',
            accountSwitched: 'Conta alternada',
            accountSwitchedRestart: 'Alternada — reinicie as sessões ativas para aplicar',
            ...
            loginStep2Enter: 'Digite nessa página o código de uso único abaixo',
            ...
            brandTagline: 'Um painel de gerenciamento de servidores open source para indivíduos. Gerencie aplicações, sites, contêineres e bancos de dados — com um assistente de IA integrado que pode realizar operações por você.',
            brandPoint1: 'O assistente de IA roda no host, não em um contêiner, então pode gerenciar a máquina inteira',
            brandPoint2: 'Cada alteração é confirmada no seu navegador em linguagem simples — sem JSON bruto',
            brandPoint3: 'Nó único, open source, auto-hospedado',
            brandFork: 'Uma versão modificada do 1Panel · GPL-3.0 · Não afiliado à FIT2CLOUD',
