...
const message = {
    ...
    aiTools: {
        console: {
            ...
            newSession: '新建會話',
            rename: '重命名',
            pickHint: '選一個會話，或新建一個',
            restart: '重启 Agent',
            restarted: '已重启，對話保留',
            finish: '結束會話',
            finishHint: '會終止這個會話的進程。對話记錄保留在磁盘上。',
            poolState: '運行中 {0} / {1}',
            chatEmpty: '這個會話還沒有對話',
            inputHint: '輸入消息，Enter 發送',
            thinking: '思考過程',
            send: '發送',
            stop: '中斷',
            terminal: '終端',
            agentLogin: 'Agent 登錄',
            loginSub: 'Claude 订阅',
            loginSubNote: '走 Pro / Max 订阅额度',
            loginConsole: 'Anthropic Console',
            loginConsoleNote: 'API 按量计费，不走订阅额度',
            loginStart: '開始登錄',
            loginStep1: '在你自己的設备上打開這個鏈接',
            loginStep2: '復制页面显示的授權碼',
            loginStep3: '把授權碼粘貼回來',
            loginWaitLink: '等待授權鏈接…',
            rawOutput: '原始輸出',
            copy: '復制',
            confirm: '確認',
            cancel: '取消',
            notLoggedIn: 'Agent 未登錄',
            loginNow: '去登錄',
            logout: '登出',
            ...
            permAsk: '退回終端',
            permAlways: '總是允許',
            brandTagline: '一個人管一台伺服器需要的東西：應用、網站、容器、資料庫，外加一個能替你動手的 AI 主控台。',
            brandPoint1: 'AI 直接跑在主機上，不進容器 —— 它管得了整台機器',
            brandPoint2: '每一次變更都在瀏覽器上確認，看得懂的一句話，不是一段 JSON',
            brandPoint3: '單節點、開源、可自建',
            brandFork: '基於 1Panel 的改動版本 · GPL-3.0 · 與飛致雲無隸屬關係',
            permFirstUse: '並授權本會話使用「{0}」板塊。',
            permConfirmAgain: '再點一次確認',
            permDanger: '危險操作，執行後不可恢復。',
            permRawInput: '原始入參',
            permModuleHint: '允許後，本會話內這個板塊的唯讀操作不再詢問；變更和刪除仍會逐次確認。不跨會話記憶。',
            permOpCount: '{0} 個操作',
            permDestructiveCount: '其中 {0} 個為刪除類',
            mcpTitle: '面板操作能力（MCP）',
            mcpHint: '讓 agent 能操作這個面板：應用、網站、憑證、容器。每一次變更仍然會先問你。',
            mcpMissing: 'vipanel-mcp 未安裝，面板操作能力不可用。',
            mcpState: '已就緒 {0} 個操作',
            agentAsks: 'Agent 有個问題',
            permOff: '權限代理未生效',
            permOffHint: '工具调用不會经過面板確認，agent 會直接以當前權限執行。',
            files: '文件',
            fileUp: '上級目錄',
            fileHome: '回到會話目錄',
            fileMkdir: '新建文件夾',
            ...
            fileEmpty: '這個目錄是空的',
            history: '歷史會話',
            historyEmpty: '沒有可重開的歷史會話',
            settings: '設置',
            poolSize: '同時運行的 Agent 實例上限',
            poolHint: '會話數不受限制。超過上限時最久未用的會話會休眠，重新打開時接回原對話，歷史不丢。',
            harnesses: 'Harness',
            capChat: '支持結构化聊天',
            capTermOnly: '仅終端',
            save: '保存',
