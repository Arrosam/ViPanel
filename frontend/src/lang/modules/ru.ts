    ...
    aiTools: {
        console: {
            ...
            loginMode: {
                ...
                devicecode: 'Вход по коду устройства',
                devicecodeNote: 'Откройте ссылку ниже на любом устройстве и введите одноразовый код',
            },
            loginFollowOutput: 'Следуйте инструкциям в выводе терминала ниже',
            install: 'Установить',
            installTitle: 'Установка агента',
            installStart: 'Начать установку',
            installRunning: 'Идёт установка, это может занять несколько минут',
            installOk: 'Установлено',
            installFail: 'Установка не удалась — смотрите вывод выше',
            done: 'Готово',
            installWarn: 'Программа будет установлена на этот сервер от имени root. Продолжайте, только если доверяете указанному выше источнику.',
            agentManage: 'Агенты',
            agentManageHint: 'Управление доступными на этом сервере агентами и учётными записями для входа.',
            addAccount: 'Добавить ещё аккаунт',
            saveAccount: 'Запомнить текущий аккаунт',
            accountSaved: 'Аккаунт сохранён',
            accountSwitched: 'Аккаунт переключён',
            accountSwitchedRestart: 'Переключено — перезапустите активные сессии, чтобы применить',
            removeAccountConfirm: 'Удалить сохранённый аккаунт? Текущий вход не затрагивается.',
            remove: 'Удалить',
            ready: 'Готово',
            agents: 'Агенты',
            proxyTitle: 'Сетевой прокси',
            proxyHint: 'Направлять исходящий трафик консоли через прокси. Используйте, если сервер не может напрямую подключиться к Anthropic или OpenAI (например, блокировка по региону).',
            proxyExample: 'Локальный HTTP-порт вашего прокси/VPN-клиента, например http://127.0.0.1:7890. SOCKS не поддерживается — ни Claude Code, ни Codex его не понимают.',
            proxyTest: 'Проверить соединение',
            proxyReachOk: 'доступно',
            notInstalled: 'Не установлено',
            harnessPick: 'Оболочка',
            signIn: 'Войти',
            loginStart: 'Start login',
            loginStep1: 'Open this link on your own device',
            loginStep2Enter: 'Введите на этой странице одноразовый код ниже',
            ...
            brandTagline: 'Панель управления сервером с открытым исходным кодом для частных лиц. Управляйте приложениями, веб-сайтами, контейнерами и базами данных — со встроенным ИИ-помощником, который может выполнять операции за вас.',
            brandPoint1: 'ИИ-помощник работает на хосте, а не в контейнере, поэтому он может управлять всей машиной',
            brandPoint2: 'Каждое изменение подтверждается в вашем браузере понятным языком — без сырого JSON',
            brandPoint3: 'Один узел, открытый исходный код, самостоятельное размещение',
            brandFork: 'Модифицированная версия 1Panel · GPL-3.0 · Не связана с FIT2CLOUD',
