    ...
    aiTools: {
        console: {
            ...
            loginMode: {
                ...
                devicecode: 'Iniciar sesión con código de dispositivo',
                devicecodeNote: 'Abre el enlace de abajo en cualquier dispositivo e introduce el código de un solo uso',
            },
            loginFollowOutput: 'Sigue las instrucciones del resultado del terminal que aparece abajo',
            install: 'Instalar',
            installTitle: 'Instalar agente',
            installStart: 'Iniciar instalación',
            installRunning: 'Instalando… puede tardar unos minutos',
            installOk: 'Instalado',
            installFail: 'Error en la instalación: consulta la salida anterior',
            done: 'Hecho',
            installWarn: 'Esto instala software en este servidor como root. Continúa solo si confías en la fuente indicada arriba.',
            agentManage: 'Agentes',
            agentManageHint: 'Gestiona los agentes de codificación disponibles en este servidor y las cuentas con las que inicias sesión.',
            addAccount: 'Añadir otra cuenta',
            saveAccount: 'Recordar esta cuenta',
            accountSaved: 'Cuenta guardada',
            accountSwitched: 'Cuenta cambiada',
            accountSwitchedRestart: 'Cambiada: reinicia las sesiones activas para aplicarlo',
            removeAccountConfirm: '¿Eliminar esta cuenta guardada? La sesión actual no se ve afectada.',
            remove: 'Eliminar',
            ready: 'Listo',
            agents: 'Agentes',
            proxyTitle: 'Proxy de red',
            proxyHint: 'Enruta el tráfico saliente de la consola a través de un proxy. Úsalo si este servidor no puede conectar directamente con Anthropic u OpenAI (por ejemplo, bloqueo por región).',
            proxyExample: 'El puerto HTTP local que expone tu cliente de proxy/VPN, p. ej. http://127.0.0.1:7890. SOCKS no es compatible: ni Claude Code ni Codex lo admiten.',
            proxyTest: 'Probar conectividad',
            proxyReachOk: 'accesible',
            ...
            brandTagline: 'Un panel de gestión de servidores de código abierto para usuarios individuales. Gestiona aplicaciones, sitios web, contenedores y bases de datos, con un asistente de IA integrado que puede realizar operaciones por ti.',
            brandPoint1: 'El asistente de IA se ejecuta en el host, no en un contenedor, por lo que puede gestionar la máquina completa',
            brandPoint2: 'Cada cambio se confirma en tu navegador en lenguaje claro, sin JSON en bruto',
            brandPoint3: 'Nodo único, de código abierto, autoalojado',
            brandFork: 'Una versión modificada de 1Panel · GPL-3.0 · No afiliada con FIT2CLOUD',
