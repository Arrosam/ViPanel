...
const message = {
    commons: {
        ...
        login: {
            ...
            password: '密碼',
            passkey: '通行金鑰登入',
            welcome: '歡迎回來，請輸入帳號密碼登入。',
            errorAuthInfo: '使用者名稱或密碼不正確，請重試。',
            errorMfaInfo: '驗證碼無效，請重試。',
            captchaHelper: '驗證碼',
            errorCaptcha: '驗證碼不正確。',
            ...
            agreeTitle: '服務協議',
            agreeContent:
                '為更好保障您的合法權益，請閱讀並同意以下協議 &laquo; <a href="https://www.fit2cloud.com/legal/licenses.html" target="_blank"> 飛致雲社區軟體許可協議 </a> &raquo;',
            logout: '登出',
            passkeyFailed: '通行金鑰登入失敗，請重試。',
            passkeyNotSupported: '目前瀏覽器或環境不支援通行金鑰，請確認已綁定網域並透過 HTTPS 存取。',
            passkeyToPassword: '通行金鑰不可用？改用密碼登入',
        },
        rule: {
            username: '請輸入使用者名稱',
            password: '請輸入密碼',
    ...
    aiTools: {
        console: {
            console: '控制台',
            empty: '暫無會話',
            cwdPlaceholder: '工作目錄，例如 /root/project',
            sessions: '會話',
            newSession: '新建會話',
            rename: '重新命名',
            pickHint: '選擇一個會話，或新建一個',
            restart: '重啟 Agent',
            restarted: '已重啟，對話保留',
            finish: '結束會話',
            finishHint: '將終止該會話的進程。對話記錄仍保留在磁碟上。',
            poolState: '執行中 {0} / {1}',
            chatEmpty: '該會話暫無對話',
            inputHint: '輸入訊息，按 Enter 傳送',
            thinking: '思考中',
            send: '傳送',
            stop: '停止',
            terminal: '終端',
            ...
            loginMode: {
                claudeai: 'Claude 訂閱',
                claudeaiNote: '使用你的 Pro / Max 訂閱額度',
                console: 'Anthropic Console',
                consoleNote: 'API 按量計費，不佔用訂閱額度',
                devicecode: '使用裝置碼登入',
                devicecodeNote: '在任一裝置開啟下方連結，輸入終端顯示的一次性驗證碼',
            },
            loginFollowOutput: '依照下方終端輸出的提示完成授權',
            install: '安裝',
            installTitle: '安裝 Agent',
            installStart: '開始安裝',
            installRunning: '正在安裝，可能需要幾分鐘',
            installOk: '安裝成功',
            installFail: '安裝失敗，請看上方輸出',
            done: '完成',
            installWarn: '這會以 root 身分在這台伺服器上安裝軟體。請確認你信任上面寫明的來源再繼續。',
            agentManage: 'Agent 管理',
            agentManageHint: '管理這台伺服器上可用的編碼 Agent，以及各自登入的帳號。',
            addAccount: '新增另一個帳號',
            saveAccount: '記住目前帳號',
            accountSaved: '帳號已儲存',
            accountSwitched: '已切換帳號',
            accountSwitchedRestart: '已切換 —— 執行中的工作階段需重啟才會生效',
            ...
            confirm: '確認',
            cancel: '取消',
            notLoggedIn: 'Agent 未登入',
            loginNow: '去登入',
            logout: '登出',
            agentScreen: 'Agent 螢幕',
            paneNone: '僅聊天',
            permTitle: '權限請求',
            permAllow: '允許',
            permDeny: '拒絕',
            permAsk: '返回終端',
            permAlways: '始終允許',
            brandTagline: '一款面向個人的開源伺服器管理面板。管理應用、網站、容器和資料庫，並內建可代為執行操作的 AI 助手。',
            brandPoint1: 'AI 助手執行在宿主機上而非容器內，可管理整台機器',
            brandPoint2: '每次變更均在瀏覽器中以自然語言確認，無需檢視原始 JSON',
            brandPoint3: '單節點、開源、可自架設',
            brandFork: '1Panel 的修改版本 · GPL-3.0 · 與飛致雲無隸屬關係',
            permFirstUse: '同時授權本會話使用「{0}」板塊。',
            permConfirmAgain: '再次點擊以確認',
            permDanger: '危險操作，執行後不可撤銷。',
            permRawInput: '原始參數',
            permModuleHint: '授權後，本會話內該板塊的唯讀操作不再詢問；變更和刪除仍會逐一確認。不跨會話保留。',
            permOpCount: '{0} 個操作',
            permDestructiveCount: '其中 {0} 個為刪除類',
            mcpTitle: '面板控制（MCP）',
            mcpHint: '讓 Agent 能操作此面板：應用、網站、憑證、容器。每次變更仍需你先確認。',
            mcpMissing: 'vipanel-mcp 未安裝，面板控制不可用。',
            mcpState: '已就緒 {0} 個操作',
            agentAsks: 'Agent 有問題要問',
            permOff: '權限代理未啟用',
            permOffHint: '工具呼叫不經面板確認，Agent 將直接執行。',
            files: '檔案',
            fileUp: '上層目錄',
            fileHome: '會話目錄',
            fileMkdir: '新建資料夾',
            ...
            fileEmpty: '空目錄',
            history: '歷史',
            historyEmpty: '沒有可重開的會話',
            settings: '設定',
            poolSize: 'Agent 並發實例上限',
            poolHint: '會話數量不限。超過上限時，最久未使用的會話將休眠，重新開啟時恢復原對話。',
            harnesses: '執行框架',
            capChat: '結構化聊天',
            capTermOnly: '僅終端',
            save: '儲存',
            ...
            restore: '還原',
            toRecycle: '移入回收筒',
            toRecycleHint: '並非永久刪除——會移入回收筒，仍可還原。',
            reconnectTerm: '重連終端',
            reconnectTermHint: '將替換當前 shell，正在執行的命令會被中斷。聊天和 Agent 不受影響。',
