    ...
    aiTools: {
        console: {
            ...
            loginMode: {
                ...
                devicecode: 'Sign in with a device code',
                devicecodeNote: 'Open the link shown below on any device and enter the one-time code',
            },
            loginFollowOutput: 'Follow the instructions shown in the terminal output below',
            install: 'Install',
            installTitle: 'Install agent',
            installStart: 'Start install',
            installRunning: 'Installing… this can take a few minutes',
            installOk: 'Installed',
            installFail: 'Install failed — see the output above',
            done: 'Done',
            installWarn: 'This installs software onto this server as root. Only proceed if you trust the source shown above.',
            agentManage: 'Agents',
            agentManageHint: 'Manage the coding agents available on this server, and the accounts you sign in with.',
            addAccount: 'Add another account',
            saveAccount: 'Remember this account',
            accountSaved: 'Account saved',
            accountSwitched: 'Switched account',
            accountSwitchedRestart: 'Switched — restart running sessions to pick it up',
            ...
            loginStep2Enter: 'Enter this one-time code on that page',
            ...
            brandTagline: 'An open-source server management panel for individuals. Manage applications, websites, containers, and databases — with a built-in AI assistant that can perform operations for you.',
            brandPoint1: 'The AI assistant runs on the host, not in a container, so it can manage the entire machine',
            brandPoint2: 'Every change is confirmed in your browser in plain language — no raw JSON',
