    ...
    aiTools: {
        console: {
            ...
            loginMode: {
                ...
                devicecode: 'Cihaz koduyla giriş yap',
                devicecodeNote: 'Aşağıdaki bağlantıyı herhangi bir cihazda açın ve tek kullanımlık kodu girin',
            },
            loginFollowOutput: 'Aşağıdaki terminal çıktısındaki yönergeleri izleyin',
            install: 'Kur',
            installTitle: 'Aracı kur',
            installStart: 'Kurulumu başlat',
            installRunning: 'Kuruluyor… birkaç dakika sürebilir',
            installOk: 'Kuruldu',
            installFail: 'Kurulum başarısız — yukarıdaki çıktıya bakın',
            done: 'Tamam',
            installWarn: 'Bu, sunucuya root olarak yazılım kurar. Yalnızca yukarıdaki kaynağa güveniyorsanız devam edin.',
            agentManage: 'Aracılar',
            agentManageHint: 'Bu sunucuda kullanılabilen kodlama aracılarını ve giriş yaptığınız hesapları yönetin.',
            addAccount: 'Başka hesap ekle',
            saveAccount: 'Bu hesabı hatırla',
            accountSaved: 'Hesap kaydedildi',
            accountSwitched: 'Hesap değiştirildi',
            accountSwitchedRestart: 'Değiştirildi — uygulanması için çalışan oturumları yeniden başlatın',
            ...
            brandTagline: 'Bireyler için açık kaynaklı sunucu yönetim paneli. Uygulamaları, web sitelerini, kapsayıcıları ve veritabanlarını yönetin — işlemleri sizin için gerçekleştirebilen yerleşik bir yapay zeka asistanıyla.',
            brandPoint1: 'Yapay zeka asistanı bir kapsayıcıda değil doğrudan sunucuda çalışır, böylece tüm makineyi yönetebilir',
            brandPoint2: 'Her değişiklik tarayıcınızda anlaşılır bir dille onaylanır — ham JSON yok',
            brandPoint3: 'Tek düğüm, açık kaynak, kendi sunucunuzda barındırılan',
            brandFork: '1Panel\'in değiştirilmiş bir sürümü · GPL-3.0 · FIT2CLOUD ile bağlantılı değildir',
